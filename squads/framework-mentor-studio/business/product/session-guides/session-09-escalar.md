# Sessao 9 — Enrollment Conversation + Conteudo
...
- Ter praticado value articulation em voz alta (homework anterior)
- Trazer a lista de 10-15 potenciais clientes com nivel de confianca indicado
- Ter lido o material dos 4Cs de enrollment conversation
- Trazer 3-5 ideias de temas de conteudo (o que poderia publicar sobre o seu framework)
...
|-------|---------|-----------|
| Check-in + revisao da lista de prospects | 10 min | Analisar a lista, identificar os 5 prioritarios |
| Contexto: o modelo 4Cs | 10 min | Apresentar Connection, Challenge, Create, Close |
| Exercicio 1: Adaptar os 4Cs ao contexto | 15 min | Criar script personalizado |
| Role-play: praticar a conversa | 20 min | Mentorado como vendedor, mentor como cliente |
| Debriefing do role-play | 5 min | O que funcionou, o que precisa de ajuste |
| Exercicio 2: Calendario de conteudo | 15 min | Planeiar 4 semanas de publicacoes |
| Homework e encerramento | 5 min | Lista GATE + primeiros 5 convites |

---

## Exercicios ao Vivo

### Exercicio 1 — Adaptar os 4Cs e Criar Script Personalizado

O modelo 4Cs (enrollment conversation):
...
Script do mentorado para C1:
> "_____________________________________________ [abertura especifica ao contexto]"
...
Script do mentorado para C4:
> "_____________________________________________ [pergunta de close]"

---

### Role-Play da Enrollment Conversation

O mentor faz o papel de potencial cliente com perfil especifico:
- Empresa: [definir contexto relevante para o mentorado]
- Desafio: [definir problema real que o framework resolve]
- Objecoes: custo, timing, ceticismo sobre resultados

Regras do role-play:
- Mentorado usa o script que acabou de criar
- Mentor interrompe com objecoes reais
- Cronometrar — 20 minutos totais
- Gravar em audio se o mentorado permitir

Debriefing (5 min):
- "O que funcionou bem?"
- "Onde ficaste menos confortavel?"
- "Qual foi o momento de maior conexao?"
- "O que mudarias no script?"

### Exercicio 2 — Calendario de Conteudo (4 Semanas)
...
**Calendario — 4 semanas (2-3 publicacoes por semana):**

| Semana | Dia | Tipo | Tema | Formato | CTA |
|--------|-----|------|------|---------|-----|
| 1 | Seg | Educar | Principio 1 do framework | Post texto | Guardar este post |
| 1 | Qui | Inspirar | Historia de cliente (anonima) | Post com imagem | Comentar se te identificas |
...
Preencher os temas especificos com o conteudo real do framework do mentorado.
...
1. Mapear definitivamente 10-15 prospects numa tabela GATE:
   - G: Ja me conhece (warm lead)?
   - A: Tem o problema que resolvo?
   - T: Tem budget/capacidade de investir?
   - E: Esta no momento certo para decidir?
2. Destacar os 5 prospects com maior score GATE
3. Preparar o primeiro contacto para cada um dos 5 — mensagem personalizada
4. Criar o primeiro peco de conteudo (nao publicar ainda — trazer para a sessao final)
...
**Tips de facilitacao:**
- O role-play e o exercicio mais valioso desta sessao — nao cortar por falta de tempo
- Objecoes mais comuns para preparar: "preciso de pensar", "nao tenho orcamento agora", "ja tentei algo assim e nao funcionou"
- Para a resposta a "preciso de pensar": "Claro. O que especificamente precisas de pensar? Posso ajudar agora."
- A lista GATE e um filtro de qualificacao, nao de exclusao — ajuda a focar energia em prospects com mais probabilidade de avancar

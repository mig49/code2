...
- Ter testado os principios nucleares com pelo menos uma pessoa
- Trazer 3 sketches ou rabiscos de possiveis estruturas visuais
- Ter pensado na resposta a: "O meu metodo leva o cliente de [estado A] para [estado B] em [N passos/elementos]"
- Reler o Knowledge Inventory especialmente os principios e o resumo executivo
...
| Tipo | Logica | Exemplo |
|------|--------|---------|
| **Sequencial (Passos)** | Fazer A antes de B, ordem importa | GROW Model, AIDA |
| **Ciclico** | Processo que se repete e melhora | Lean Startup Build-Measure-Learn |
| **Hierarquico (Piramide)** | Fundacoes antes de avancados | Maslow, Pyramid of Choice |
| **Matricial** | Dois eixos criam quadrantes | Eisenhower Matrix, BCG Matrix |
| **Principios** | Valores e crencas guiam decisoes | The 4 Agreements, Brand Archetypes |
...
Partir dos principios nucleares do Knowledge Inventory e simplificar:

**Passo 1 — Listar tudo:**
Escrever todos os principios/passos no quadro ou papel sem filtro.

**Passo 2 — Agrupar:**
Que principios pertencem ao mesmo "momento" da jornada do cliente? Criar grupos de 2-3.

**Passo 3 — Nomear grupos:**
Dar um nome de trabalho a cada grupo (pode ser feio — e temporario).

**Passo 4 — Testar a sequencia:**
...
1. Brainstorm de 10 possiveis nomes para o framework — sem julgamento, quantidade sobre qualidade
2. Para cada fase/elemento, escrever 1-2 frases descrevendo o que acontece nessa fase
3. Pensar num acronimo possivel (ex: PONTE, GROW, AIDA)
4. Opcional: procurar 3 frameworks de referencia na area e analisar como foram nomeados

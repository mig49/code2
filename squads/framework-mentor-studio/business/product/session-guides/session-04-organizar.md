# Sessao 4 — Organizacao e Destilacao
...
- Ter o brain dump bruto + adicoes da semana num unico documento
- Ter sublinhado ou marcado as frases que "soam mais verdadeiras"
- Ter identificado 3-5 frases candidatas a titulos de capitulo
- Ter pensado na resposta a: "Se ensinasse o que sei em 4 passos, quais seriam?"
...
|-------|---------|-----------|
| Check-in + leitura do brain dump aumentado | 10 min | O mentorado le em voz alta partes que sublinhou |
| Contexto: sistema PARA | 5 min | Explicar Projects, Areas, Resources, Archives |
| Exercicio 1: Classificacao PARA | 20 min | Organizar items do brain dump em categorias |
| Contexto: Progressive Summarization | 5 min | Explicar os 3 niveis de destilacao |
| Exercicio 2: Destilacao de principios | 20 min | Extrair os 5-7 principios nucleares |
| Sintese: Knowledge Inventory | 5 min | Rever o inventario completo |
| Homework e encerramento | 5 min | Preparar para fase N |
...
### Exercicio 2 — Progressive Summarization: Destilacao de Principios

Aplicar 3 camadas de destilacao ao material da categoria Resources:

**Camada 1 — Sublinhar:** O mentorado le o brain dump e sublinha o que parece importante (ja feito em parte no homework).

**Camada 2 — Negrito:** Das partes sublinhadas, colocar a negrito apenas o que parece *crucial* — frases que, se perdesse tudo o resto, queria guardar.

**Camada 3 — Resumo executivo:** Das frases a negrito, escrever um resumo de 1-3 paragrafos que captura a essencia de tudo o que sabe.
...
- E uma afirmacao, nao uma pergunta
- Contraria alguma crenca comum no mercado (idealmente)
- E proprio — soa como ele, nao como um livro
- E memoravel — consegue dize-lo de cor

---

## Deliverable da Sessao

**Knowledge Inventory completo** contendo:
